...
def _draw_icon(screen: Screen, index: int) -> int:
    ...
    screen.cursor.bg, screen.cursor.fg = as_rgb(0xF5E0DC), as_rgb(0xF5E0DC)
...
def _draw_left_status(
    ...
    screen.cursor.bg, screen.cursor.fg = as_rgb(0xF5E0DC), as_rgb(0xC88141)
    ...
    screen.cursor.fg = 0
    if not is_last:
        screen.cursor.bg = as_rgb(0xC88141)
...
def _draw_right_status(screen: Screen, is_last: bool, cells: list) -> int:
    ...
    for color, status in cells:
        ...
        screen.draw(status)
    screen.cursor.bg = 0
    screen.cursor.bg = as_rgb(0xF5E0DC)
    screen.draw(" ")
